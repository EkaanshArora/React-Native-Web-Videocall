...
import { Image, View, TouchableOpacity, Text, StyleSheet, Picker, Platform, StatusBar } from 'react-native';
    ...
    <View style={styles.mainContainer}>
            ...
            <View style={styles.containerTopLeft}>
              <View style={styles.pickerContainer}>
                ...
                <Picker
                  ...
                  style={styles.picker}
                  onValueChange={(itemValue, itemIndex) => setSelectedCamValue(itemValue)}>
              ...
              <View style={styles.pickerContainer}>
                ...
                <Picker
                  ...
                  style={styles.picker}
                  onValueChange={(itemValue, itemIndex) => setSelectedMicValue(itemValue)}>
      ...
      <View style={styles.containerBottom}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity style={activePreset === 0 ?
            styles.qualityButtonActive : styles.qualityButton}
            onPress={() => setActivePreset(0)}>
            <Text style={activePreset === 0 ?
              styles.qualityButtonTextActive : styles.qualityButtonText}>
              360p</Text>
          </TouchableOpacity>
          <TouchableOpacity style={activePreset === 1 ?
            styles.qualityButtonActive : styles.qualityButton}
            onPress={() => setActivePreset(1)}>
            <Text style={activePreset === 1 ?
              styles.qualityButtonTextActive : styles.qualityButtonText}>
              480p</Text>
          </TouchableOpacity>
          <TouchableOpacity style={activePreset === 2 ?
            styles.qualityButtonActive : styles.qualityButton}
            onPress={() => setActivePreset(2)}>
            <Text style={activePreset === 2 ?
              styles.qualityButtonTextActive : styles.qualityButtonText}>
              720p</Text>
          </TouchableOpacity>
        </View>
